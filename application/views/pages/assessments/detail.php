            ...
            <div class="card shadow-sm border-start border-4 border-<?= $p_class ?> h-100">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-start mb-3">
                        <div>
                            <p class="text-muted mb-1 small">KELAS</p>
                    ...
                    <div class="row text-center">
                        <div class="col-6 border-end">
                            ...
                            <strong><?= date('d M Y', strtotime($assessment->assessment_date)) ?></strong>
                        </div>
                        <div class="col-6">
                            <p class="text-muted mb-1 small">DINILAI OLEH</p>
                            <strong><?= htmlspecialchars($assessment->admin_name) ?></strong>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-md-4 mb-3">
            <div class="card shadow-sm bg-<?= $p_class ?> text-white h-100">
                <div class="card-body d-flex flex-column align-items-center justify-content-center text-center">
                    <p class="mb-1 fw-semibold opacity-75">TOTAL POIN</p>
                ...
                <table class="table table-hover mb-0">
                    <thead class="table-light">
                        <tr>
                            ...
                            <th class="text-center" width="200">Kondisi</th>
                            <th class="text-center" width="120">Poin Diperoleh</th>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <span class="badge bg-label-<?= $cond_class ?> px-3 py-2">
                    ...
                    <tfoot class="table-light">
                        <tr>
                            ...
                            <td class="text-center fw-bold fs-4 text-<?= $p_class ?>"><?= $assessment->total_point ?></td>
                        </tr>
                    </tfoot>
                </table>
            </div>
